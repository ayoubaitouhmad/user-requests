(()=>{
    ...
    window.app.admin.users.charts = () => {
        ...
        window.axios.get('/admin/dashboard/users/chart/data')
            .then(response => {
        ...
        function getData(data) {
           ...
           let women = data.body.userCountWomen;
           let men = data.body.userCountMen;
           makeAreaCharts(men, women);

            let userCountByMonthCurYear = data.body.userCountByMonthCurYear;
            let userCountByMonthLastYear = data.body.userCountByMonthLastYear;
            ...
            let areaChartConfig = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'users inscription  percentage by gender in  ' + new Date().getFullYear() ,
                            position: "top",
                            align: "center",
                            fontSize: 16
                        }
            ...
            const barChartConfig = {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'numbers of users per month  in ' + new Date().getFullYear() + '/' + (new Date().getFullYear() - 1)
                        }
                    },
