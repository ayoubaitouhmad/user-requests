        ...
        <ul class="navbar-nav navbar-nav-right">
            ...
            <li class="nav-item nav-profile dropdown">
                <a class="nav-link  dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
                    ...
                    <img id="admin-profile-photo" src="{{$admin->admin_photo !== null && $admin->admin_photo !== "" ? $admin->admin_photo: '/img/unknown.png'}}" class="css-transitions-only-after-page-load" alt="profile"/>
                    <span class="nav-profile-name">{{$admin->admin_name ?? ''}}</span>
                </a>
                <div class="dropdown-menu user-tools dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
